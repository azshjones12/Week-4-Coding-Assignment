...
public class CollectionsListSetMap {
	...
	public static void main(String[] args) {
		 ...
		 * iteration, and a value that is the employeeName at position i of the employeeNames 
		 * ArrayList. Increment i so that each iteration grabs the next element in the ArrayList.
		 */	
		int i = 0;
		for (Integer id: ids) {
		...
		/*11. Iterate over the employeeNames ArrayList and append each name, followed by a 
